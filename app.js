...
function getNewQuestion(){
    ...
    for(let i=0; i<optionLen; i++){
        ...
        // get the position of 'optionIndex' from the avaliable options Array
        const index2 = availableOptions.indexOf(optonIndex);
        // remove the 'optionIndex' from the avaliable options Array, so that the option doesnot repeat
